        ...
        <div id="head_right">
          <div class="top">
            <em>
              ...
              <i @click="go_where('search_food')">搜索单位</i
              ><i @click="go_where('login')">快速登录</i></em
            >
          </div>
          <div class="bottom">
            <p><i>至善明德</i> <i>严于律己</i></p>
          </div>
        </div>
      ...
      <KeepAlive>
        <div id="show_detail" v-show="show_food">
          ...
          <div class="content">
            ...
            <p>
              <em>单位名称:</em><em> {{ current_food.name }}</em>
            </p>
            <p>
              <em>岗位名称:</em><em> 辅导员</em>
            </p>
            <p>
              <em>学历要求:</em><em> 大学本科</em>
            </p>
            <p>
              <em>政治面貌:</em><em> 中共党员</em>
            </p>
            <p>
              <em>其他信息:</em><em> 满足最低服务期限</em>
            </p>
            <em>
              <i class="estimate_btn" @click="index_show_estimate">{{
                pre_estimate_num
              }}</i>  
              <i class="code_btn" @click="code_buy">岗位信息</i
              ><i class="balance_btn" @click="balance_buy">报名岗位</i></em
            >
...
food = [{name:'天津科技大学',img:'s1.webp'},{name:'天津工业大学',img:'s1.webp'},{name:'天津财经大学',img:'s1.webp'},{name:'天津城建大学',img:'s1.webp'},{name:'河北医科大学',img:'s1.webp'},{name:'河北经贸大学',img:'s1.webp'},{name:'太原科技大学',img:'s1.webp'},{name:'大连海事大学',img:'s1.webp'},{name:'大连海洋大学',img:'s1.webp'},{name:'吉林师范大学',img:'s1.webp'},{name:'广东医科大学',img:'s1.webp'},{name:'重庆理工大学',img:'s1.webp'},]
swiper = ['1.jpg','2.jpg']
detail = [{content:'单位:天津科技大学  岗位:辅导员  要求:大学本科  工资:3000-5000元'},
{content:'单位:天津科技大学  岗位:辅导员  要求:大学本科  工资:2000-3000元'},
{content:'单位:天津工业大学  岗位:小讲师  要求:共青团员  工资:3000-5000元'},
{content:'单位:天津医科大学  岗位:正教授  要求:大学硕士  工资:5000-6000元'},
{content:'单位:天津城建大学  岗位:副教授  要求:大学专科  工资:2000-3000元'},]
...
let code_buy = async () => {
  ...
  timer = setInterval(async () => {
    ...
    if (finish) code_buy_success({ outTradeNo }), clearInterval(timer);
  }, 2000);
};
